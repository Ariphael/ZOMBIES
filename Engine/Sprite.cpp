...
void Sprite::DrawZombie(int x, int y, Graphics& gfx)
{
	//Arms
	for (int w = 0; w <= 10; w++) {
		for (int h = 0; h <= 25; h++) {
			gfx.PutPixel(x + w, y + h, 165, 42, 42);
			gfx.PutPixel(x + w+30, y + h, 165, 42, 42);
		}
		for (int h = 25; h <= 30; h++) {
			gfx.PutPixel(x + w, y + h, 50,144,36);
			gfx.PutPixel(x + w+30, y + h, 50, 144, 36);
		}
	}
	//Head
	for (int w = 0; w <= 20; w++) {
		for (int h = 0; h <= 20; h++) {
			gfx.PutPixel(x + 10 + w, y + h, 128, 128, 128);
		}
	}
}
...
void Sprite::DrawTank(float X, float Y, Graphics & gfx)
{
	...
	for (int w = 0; w <= 9; w++) {
		for (int h = 0; h <= 25; h++) {
			gfx.PutPixel(x + w + 8, y + h, 160, 160, 160);
		}
	}
	//Base
	for (int w = 0; w <= 25; w++) {
		for (int h = 0; h <= 25; h++) {
			gfx.PutPixel(x + w, y + 25 + h, 0,102,0);
		}
	}
	//Operator
	for (int w = 0; w <= 19; w++) {
		for (int h = 0; h <= 19; h++) {
			gfx.PutPixel(x + w+3, y + h + 25, 102, 51, 0);
		}
	}

}

void Sprite::DrawBullet(int x, int y, Graphics & gfx)
{
	for (int w = 0; w <= 9; w++) {
		for (int h = 0; h <= 9; h++) {
			gfx.PutPixel(x + w, y + h, 255, 215, 0);
		}
	}
}

void Sprite::DrawGameOver(int x, int y, Graphics & gfx)
{
